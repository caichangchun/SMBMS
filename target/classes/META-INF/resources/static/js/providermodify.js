...
var procode=$("#modifyprocode").val();
var proname=$("#modifyproname").val();
var procontact=$("#modifyprocontact").val();
var prophone=$("#modifyprophone").val();
var proaddress=$("#modifyproaddress").val();
var profax=$("#modifyprofax").val();
var prodesc=$("#modifyprodesc").val();
...
$(function(){
	...
	$("#proCode").val(procode);
    $("#proName").val(proname);
    $("#proContact").val(procontact);
    $("#proPhone").val(prophone);
    $("#proAddress").val(proaddress);
    $("#proFax").val(profax);
    $("textarea[name='prodesc']").html(prodesc);
